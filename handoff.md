...
**Bronze → silver → gold → serve is complete, tested, and green — the latest real
`prod-private` acceptance build is 154/154** (20 models, 130 tests, 1 snapshot,
2 seeds, 1 hook). The full `macro → sector → holdings`
