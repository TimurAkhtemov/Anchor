...
- **Private daily operation, local only.** A weekday 21:30 ET macOS LaunchAgent re-pulls
...
- **Quantities refresh once per weekday, not continuously.** The private 21:30 ET run
